        ...
        methods: {
            ...
            step: function(e, i, s) {
                var n, r = t(i).attr("type"),
                    ...
                    d = !0;
                if (r && !l.test(o.join())) throw new Error(a);
                return n = h(s), (h(e) > n || u(e) % u(s) != 0) && (d = !1), this.optional(i) || d
            },
...
! function(e) {
    ...
    s.prototype = {
        ...
        open: function(n) {
            ...
            if (!1 === n.isObj) {
                ...
                if (!t.isOpen) {
                    ...
                    u("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (p("MarkupParse", function(e, t, n, i) {
                    ...
                    }, 16), t.isOpen = !0, t.updateSize(g), u("Open"), n
                }
                t.updateItemHTML()
            }
        },
        ...
        updateItemHTML: function() {
            ...
            var i = n.type;
            if (u("BeforeChange", [t.currItem ? t.currItem.type : "", i]), t.currItem = n, !t.currTemplate[i]) {
                var a = !!t.st[i] && t.st[i].markup;
                u("FirstMarkupParse", a), t.currTemplate[i] = !a || e(a)
            }
            o && o !== n.type && t.container.removeClass("mfp-" + o + "-holder");
            var r = t["get" + i.charAt(0).toUpperCase() + i.slice(1)](n, t.currTemplate[i]);
            t.appendContent(r, i), n.preloaded = !0, u("Change", n), o = n.type, t.container.prepend(t.contentContainer), u("AfterChange")
        },
        appendContent: function(e, n) {
            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[n] ? t.content.find(".mfp-close").length || t.content.append(f()) : t.content = e : t.content = "", u("BeforeAppend"), t.container.addClass("mfp-" + n + "-holder"), t.contentContainer.append(t.content)
        },
        parseEl: function(n) {
            var i, o = t.items[n];
            if (o.tagName ? o = {
            ...
            return o.type = i || t.st.type || "inline", o.index = n, o.parsed = !0, t.items[n] = o, u("ElementParse", o), t.items[n]
        },
        ...
        updateStatus: function(e, i) {
            if (t.preloader) {
                ...
                u("UpdateStatus", o), e = o.status, i = o.text, t.preloader.html(i), t.preloader.find("a").on("click", function(e) {
        ...
        _parseMarkup: function(t, n, i) {
            var o;
            i.data && (n = e.extend(i.data, n)), u("MarkupParse", [t, n, i]), e.each(n, function(n, i) {
        ...
        if ("string" == typeof n)
            if ("open" === n) {
                var o, a = l ? i.data("magnificPopup") : i[0].magnificPopup,
            ...
            getInline: function(n, i) {
                if (y(), n.src) {
                    ...
                    if (a.length) {
                        ...
                        r && r.tagName && (h || (v = o.hiddenClass, h = d(v), v = "mfp-" + v), C = a.after(h).detach().removeClass(v)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule("ajax", {
        ...
        proto: {
            initAjax: function() {
                t.types.push("ajax"), w = t.st.ajax.cursor, p("Close.ajax", I), p("BeforeChange.ajax", I)
            },
            getAjax: function(n) {
                ...
                var i = e.extend({
                    ...
                    success: function(i, o, a) {
                        ...
                        u("ParseAjax", r), t.appendContent(e(r.data), "ajax"), n.finished = !0, b(), t._setFocus(), setTimeout(function() {
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            _onImageHasSize: function(e) {
                e.img && (e.hasSize = !0, x && clearInterval(x), e.isCheckingImgSize = !1, u("ImageHasSize", e), e.imgHidden && (t.content && t.content.removeClass("mfp-loading"), e.imgHidden = !1))
            },
            ...
            getImage: function(n, i) {
                var o = 0,
                    a = function() {
                        n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, u("ImageLoadComplete")) : ++o < 200 ? setTimeout(a, 100) : r())
                    },
                    r = function() {
                ...
                }, n), t.resizeImage(), n.hasSize ? (x && clearInterval(x), n.loadError ? (i.addClass("mfp-loading"), t.updateStatus("error", s.tError.replace("%url%", n.src))) : (i.removeClass("mfp-loading"), t.updateStatus("ready")), i) : (t.updateStatus("loading"), n.loading = !0, n.hasSize || (n.imgHidden = !0, i.addClass("mfp-loading"), t.findImageSize(n)), i)
            }
        }
    });
    var T, _ = function() {
    ...
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(n) {
                ...
                var s = {
                    width: i.width(),
                    height: (l ? i.innerHeight() : i[0].offsetHeight) - r - a
                };
        ...
        proto: {
            initGallery: function() {
                ...
                a += " mfp-gallery", p("Open" + o, function() {
                    ...
                    o.counter = r > 1 ? E(n.tCounter, a.index, r) : ""
            ...
            _preloadItem: function(n) {
                if (n = S(n), !t.items[n].preloaded) {
                    var i = t.items[n];
                    i.parsed || (i = t.parseEl(n)), u("LazyLoad", i), "image" === i.type && (i.img = e('<img class="mfp-img" />').on("load.mfploader", function() {
                        i.hasSize = !0
    ...
    e.mask = {
        ...
        mask: function(n, o) {
            ...
            return o = e.extend({
                ...
                "?" == t ? (h--, f = e) : l[t] ? (u.push(new RegExp(l[t])), null === s && (s = u.length - 1), e < f && (g = u.length - 1)) : u.push(null)
            }), this.trigger("unmask").each(function() {
                function c() {
                    if (o.completed) {
                        for (var e = s; e <= g; e++)
                            if (u[e] && S[e] === d(e)) return;
                        o.completed.call(R)
                    }
                }
                ...
                function b(e, t) {
                    ...
                    if (!(e < 0)) {
                        for (n = e, a = p(t); n < h; n++)
                            if (u[n]) {
                                if (!(a < h && u[n].test(S[a]))) break;
                                S[n] = S[a], S[a] = d(a), a = p(a)
                            }
                        j(), R.caret(Math.max(s, e))
                    }
                }
                ...
                function k(e) {
                    ...
                    for (t = e, n = d(e); t < h; t++)
                        if (u[t]) {
                            if (a = p(t), i = S[t], S[t] = n, !(a < h && u[a].test(i))) break;
                            n = i
                        }
                }
                ...
                function A(e) {
                    ...
                    for (t = 0, a = 0; t < h; t++)
                        ...
                        } else S[t] === i.charAt(a) && a++, t < f && (r = t);
                    return e ? j() : r + 1 < f ? o.autoclear || S.join("") === T ? (R.val() && R.val(""), x(0, h)) : j() : (j(), R.val(R.val().substring(0, r + 1))), f ? t : s
                }
                var R = e(this),
                    S = e.map(n.split(""), function(e, t) {
                        if ("?" != e) return l[e] ? d(t) : e
                    }),
                    T = S.join(""),
                    w = R.val();
                R.data(e.mask.dataName, function() {
                    ...
                    if (!R.prop("readonly")) {
                        clearTimeout(t);
                        var e;
                        w = R.val(), e = A(), t = setTimeout(function() {
                            R.get(0) === document.activeElement && (j(), e == n.replace("?", "").length ? R.caret(0, e) : R.caret(e))
                        }, 10)
                    }
                }).on("blur.mask", y).on("keydown.mask", function(e) {
                    if (!R.prop("readonly")) {
                        var t, n, i, r = e.which || e.keyCode;
                        m = R.val(), 8 === r || 46 === r || a && 127 === r ? (n = (t = R.caret()).begin, (i = t.end) - n == 0 && (n = 46 !== r ? v(n) : i = p(n - 1), i = 46 === r ? p(i) : i), x(n, i), b(n, i - 1), e.preventDefault()) : 13 === r ? y.call(this, e) : 27 === r && (R.val(w), R.caret(0, A()), e.preventDefault())
                    }
                }).on("keypress.mask", function(t) {
                    if (!R.prop("readonly")) {
                        var n, a, i, o = t.which || t.keyCode,
                            l = R.caret();
                        t.ctrlKey || t.altKey || t.metaKey || o < 32 || !o || 13 === o || (l.end - l.begin != 0 && (x(l.begin, l.end), b(l.begin, l.end - 1)), (n = p(l.begin - 1)) < h && (a = String.fromCharCode(o), u[n].test(a)) && (k(n), S[n] = a, j(), i = p(n), r ? setTimeout(function() {
                            e.proxy(e.fn.caret, R, i)()
                        }, 0) : R.caret(i), l.begin <= g && c()), t.preventDefault())
                    }
                ...
                }), i && r && R.off("input.mask").on("input.mask", function(e) {
                    var t = R.val(),
                        n = R.caret();
                    if (m && m.length && m.length > t.length) {
                        for (A(!0); n.begin > 0 && !u[n.begin - 1];) n.begin--;
                        if (0 === n.begin)
                            for (; n.begin < s && !u[n.begin];) n.begin++;
                        R.caret(n.begin, n.begin)
                    } else {
                        A(!0);
                        var a = t.charAt(n.begin);
                        n.begin < h && (u[n.begin] ? u[n.begin].test(a) && n.begin++ : (n.begin++, u[n.begin].test(a) && n.begin++)), R.caret(n.begin, n.begin)
                    }
                    c()
                }), A()
            })
...
! function(t, e) {
    ...
    return function(t) {
        ...
        function o(t, e, i) {
            function o(t, e) {
                if (0 !== t.length)
                    for (E = t.length; E--;)(T = t[E]).callback.call(s, e, s), T.isOne && t.splice(E, 1)
            }
            var s = this;
...
! function(t) {
    t.fn.tableHeadFixer = function(n) {
        function o() {
            function o(n) {
                n.each(function(n, o) {
                    var o = t(o),
                        i = t(o).parent(),
                        r = o.css("background-color");
                    r = "transparent" == r || "rgba(0, 0, 0, 0)" == r ? null : r;
                    var e = i.css("background-color"),
                        a = (e = "transparent" == e || "rgba(0, 0, 0, 0)" == e ? null : e) || "white";
                    a = r || a, o.css("background-color", a)
                })
            }

            function i(n, o) {
                for (var i = c.left, r = 1, e = 1; e <= i; e += r) {
                    var a = r > 1 ? e - 1 : e,
                        l = t(n).find("> *:nth-child(" + a + ")"),
                        f = l.prop("colspan");
                    l.cellPos().left < i && o(l), r = f
                }
            }

            function r(n, o) {
                for (var i = c.right, r = 1, e = 1; e <= i; e += r) {
                    var a = r > 1 ? e - 1 : e,
                        l = t(n).find("> *:nth-last-child(" + a + ")"),
                        f = l.prop("colspan");
                    o(l), r = f
                }
            }
            ...
            var a = {
                ...
                c = t.extend({}, a, n);
            c.table = this, c.parent = t(c.table).parent(),
                function() {
                    var n = t(c.parent),
                        o = t(c.table);
                    n.append(o), n.css({
                        ...
                        var t = n[0].scrollWidth,
                            o = n[0].clientWidth,
                            i = n[0].scrollHeight,
                            r = n[0].clientHeight,
                            e = n.scrollTop(),
                            a = n.scrollLeft();
                        c.head && this.find("thead tr > *").css("top", e), c.foot && this.find("tfoot tr > *").css("bottom", i - r - e), c.left > 0 && c.leftColumns.css("left", a), c.right > 0 && c.rightColumns.css("right", t - o - a)
                    }.bind(o))
                }(), 1 == c.head && function() {
                    var n = t(c.table).find("thead"),
                        i = (n.find("tr"), n.find("tr > *"));
                    o(i), i.css({
                        position: "relative"
                    })
                }(), 1 == c.foot && function() {
                    var n = t(c.table).find("tfoot"),
                        i = (n.find("tr"), n.find("tr > *"));
                    o(i), i.css({
                        position: "relative"
                    })
                    ...
                    var n = t(c.table);
                    c.leftColumns = t(), n.find("tr").each(function(t, n) {
                        i(n, function(t) {
                            c.leftColumns = c.leftColumns.add(t)
                        })
                    }), c.leftColumns.each(function(n, i) {
                        o(i = t(i)), i.css({
                            position: "relative"
                        })
                    })
                    ...
                    c.right;
                    c.rightColumns = t();
                    var i = n.find("thead").find("tr"),
                        a = n.find("tbody").find("tr"),
                        l = null;
                    i.each(function(t, n) {
                        r(n, function(n) {
                            0 === t && (l = n), c.rightColumns = c.rightColumns.add(l)
                        })
                    }), a.each(function(t, n) {
                        e(n, function(t) {
                            c.rightColumns = c.rightColumns.add(t)
                        })
                    }), c.rightColumns.each(function(n, i) {
                        o(i = t(i)), i.css({
                            position: "relative",
                            "z-index": "9999"
                        })
                ...
                function() {
                    var n = t(c.table);
                    if (c.head && (c.left > 0 && (o = n.find("thead tr")).each(function(n, o) {
                            i(o, function(n) {
                                t(n).css("z-index", c["z-index"] + 1)
                            })
                        }), c.right > 0 && (o = n.find("thead tr")).each(function(n, o) {
                            solveRightColspan(o, function(n) {
                                t(n).css("z-index", c["z-index"] + 1)
                            })
                        })), c.foot && (c.left > 0 && (o = n.find("tfoot tr")).each(function(n, o) {
                            i(o, function(n) {
                                t(n).css("z-index", c["z-index"])
                            })
                        }), c.right > 0)) {
                        var o = n.find("tfoot tr");
                        o.each(function(n, o) {
                            solveRightColspan(o, function(n) {
                                t(n).css("z-index", c["z-index"])
                            })
                ...
                }(), t(c.parent).trigger("scroll"), t(window).resize(function() {
                    t(c.parent).trigger("scroll")
                })
        }
        return this.each(function() {
            o.call(this)
...
function(t) {
    function n(n) {
        var o = [];
        n.children("tr").each(function(n, i) {
            t(i).children("td, th").each(function(i, r) {
                var e, a, c = t(r),
                    l = 0 | c.attr("colspan"),
                    f = 0 | c.attr("rowspan");
                for (l = l || 1, f = f || 1; o[n] && o[n][i]; ++i);
                for (e = i; e < i + l; ++e)
                    for (a = n; a < n + f; ++a) o[a] || (o[a] = []), o[a][e] = !0;
                var s = {
                    top: n,
                    left: i
                };
    ...
    t.fn.cellPos = function(t) {
        var o = this.first(),
            i = o.data("cellPos");
        return i && !t || n(o.closest("table, thead, tbody, tfoot")), i = o.data("cellPos")
    }
}(jQuery);
! function(e, t) {
    ...
    return function(i) {
        function a() {
            for (var i = 0; i < m.length;) {
                var d = m[i],
                    ...
                    c = n(u);
                if (c) {
                    var s = d.getAttribute("xlink:href") || d.getAttribute("href");
                    if (!s && o.attributeName && (s = d.getAttribute(o.attributeName)), r)
                        if (!o.validate || o.validate(s, c, d)) {
                            u.removeChild(d);
                            var g = s.split("#"),
                                b = g.shift(),
                                h = g.join("#");
                            if (b.length) {
                                var p = l[b];
                                p || ((p = l[b] = new XMLHttpRequest).open("GET", b), p.send(), p._embeds = []), p._embeds.push({
                                    parent: u,
                                    svg: c,
                                    id: h
                                }), t(p)
        ...
        r = "polyfill" in o ? o.polyfill : d.test(navigator.userAgent) || (navigator.userAgent.match(c) || [])[1] < 10547 || (navigator.userAgent.match(u) || [])[1] < 537 || s.test(navigator.userAgent) && g;
        var l = {},
...
$(function() {
    ! function(e, t) {
        var a, o, i = 0;
        for (a = 0, o = e.length; a < o; a++) ! function(a, o) {
            a.onload = function() {
                ++i == e.length && t && t()
            }, a.src = o
        }(new Image, e[a])
    }(["images/bg-begin-poster.png"], function() {
        setTimeout(function() {
            $("body").addClass("pace-done"), runScrollMonitor()
        }, 500)
    })
}), $(function() {
    if (svg4everybody(), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? $("html").addClass("touch-device") : $("html").addClass("no-touch-device"), $("html").is(".no-touch-device")) {
        ...
        new ScrollMagic.Scene({
            ...
            duration: 0,
            triggerHook: 0
        }).setClassToggle(".nav-dropdown", "is-fixed").addTo(e)
    }
    $(".nav-btn").on("click", function(e) {
        ...
        $(".nav-btn").removeClass("is-active").closest("body").removeClass("is-navOpen")
    ...
    var t = $(".nav-menu"),
        a = t.outerHeight() + 80,
        o = t.find("a:not(.other)"),
        i = o.map(function() {
            var e = $($(this).attr("href"));
            if (e.length) return e
        });
    $(window).scroll(function() {
        var e = $(this).scrollTop() + a,
            t = i.map(function() {
                if ($(this).offset().top < e) return this
            }),
            s = (t = t[t.length - 1]) && t.length ? t[0].id : "";
        o.removeClass("is-active").filter("[href='#" + s + "']").addClass("is-active")
    });
    var s = '<svg class="icon-prev"><use xlink:href="/sprites/sprite.svg#icon-prev"></use></svg>',
        n = '<svg class="icon-next"><use xlink:href="/sprites/sprite.svg#icon-next"></use></svg>';
    $(".program-carousel").owlCarousel({
        ...
        }), $(".program-carousel").on("changed.owl.carousel", function(e) {
            e.target;
            var t = e.item.index + 1;
            $(".program-tabs-menu li[data-day=" + t + "]").addClass("is-active").siblings().removeClass("is-active")
        }), $(".program-tabs-menu").on("click", "li:not(.active)", function() {
            var e = $(this).data("day") - 1;
            $(".program-carousel").trigger("to.owl.carousel", [e, 300])
        }),$(document).ready(function(){
        var e = $('.program-tabs-menu .is-active').data("day") - 1;
        $(".program-carousel").trigger("to.owl.carousel", [e, 300])
    })
        ...
        }), $(".js-accordion").on("click", "dt", function(e) {
            e.preventDefault(), $(this).is(".is-active") ? $(this).removeClass("is-active").next("dd").slideUp("fast") : ($(this).closest(".js-accordion").find("dt").removeClass("is-active").next("dd").slideUp("fast"), $(this).addClass("is-active").next("dd").slideDown("fast"))
        }), $(".js-mask-phone").mask("+7 (999) 999-9999"),
        function(e) {
            function t(t) {
                var a = [];
                t.children("tr").each(function(t, o) {
                    e(o).children("td, th").each(function(o, i) {
                        var s, n, l = e(i),
                            r = 0 | l.attr("colspan"),
                            c = 0 | l.attr("rowspan");
                        for (r = r || 1, c = c || 1; a[t] && a[t][o]; ++o);
                        for (s = o; s < o + r; ++s)
                            for (n = t; n < t + c; ++n) a[n] || (a[n] = []), a[n][s] = !0;
                        var d = {
                            top: t,
                            left: o
                        };
            ...
            e.fn.cellPos = function(e) {
                var a = this.first(),
                    o = a.data("cellPos");
                return o && !e || t(a.closest("table, thead, tbody, tfoot")), o = a.data("cellPos")
            }
        }(jQuery), $(".js-table-hover").on("mouseenter mouseleave", "th, td", function(e) {
            var t = $(this).cellPos().left;
            $(this).closest("table").find("th, td").each(function() {
                $(this).cellPos().left == t ? $(this).addClass("is-hightlight") : $(this).removeClass("is-hightlight")
            })
        }), $(window).width() < 992 && $(".js-table-hover").tableHeadFixer({
            left: 1
    ...
    window.runScrollMonitor = function() {
        setTimeout(function() {
            l || (l = !0, $(".wow").each(function(e, t) {
                var a, o = scrollMonitor.create($(t));
                $(window).width() < 768 ? a = 0 : $(t).data("wow-delay");
                var i;
                $(t).data("animation-name") && (i = $(t).data("animationName")), o.enterViewport(function() {
                    $(t).addClass(i), $(t).css({
    ...
    google.maps.event.addDomListener(window, "load", function() {
        e = new google.maps.Map(document.getElementById("contacts-map"), {
            center: {
                lat: 55.71669,
                lng: 37.55231
            },
        ...
        function MapsMarker(x, y, windowContent){
            ...
            elem.addListener('click', function() {
                ...
                infowindow.open(e, elem);
            });
        }

        function MapsMarker1(x, y, windowContent){
            var elem = new google.maps.Marker({
                position: {
                    lat: x,
                    lng: y
        ...
        MapsMarker(55.716699,37.552310,'<span style="color:black">Crossfit 19.05</span>');
   /*   MapsMarker(55.76297878,37.55508456,'<span style="color:black">Удобная стоянка</span>');
        MapsMarker(55.76260819,37.55586898,'<span style="color:black">Стоянка на территории 300 руб.</span>');
        MapsMarker(55.76347439,37.55861557,'<span style="color:black">Удобная стоянка</span>'); */


        var flightPlanCoordinates = [
            new google.maps.LatLng( 55.763819, 37.562107),
            new google.maps.LatLng( 55.763597, 37.561216),
            new google.maps.LatLng( 55.763550, 37.560259),
            new google.maps.LatLng( 55.763180, 37.560106),
            new google.maps.LatLng( 55.763428, 37.558159),
            new google.maps.LatLng( 55.763355, 37.558159),
            new google.maps.LatLng( 55.763344, 37.557992),
            new google.maps.LatLng( 55.762692, 37.557971),
            new google.maps.LatLng( 55.761538, 37.557920),
            new google.maps.LatLng( 55.761497, 37.557998),
            new google.maps.LatLng( 55.760987, 37.557974)
          ];
          var flightPlanCoordinates1 = [
            new google.maps.LatLng(55.762692, 37.557971),
            new google.maps.LatLng(55.762684, 37.557553),
            new google.maps.LatLng(55.762751, 37.557033),
            new google.maps.LatLng(55.762708, 37.556925),
            new google.maps.LatLng(55.762714, 37.556228),
            new google.maps.LatLng(55.762739, 37.555563),
            new google.maps.LatLng(55.762516, 37.555549),
            new google.maps.LatLng(55.762539, 37.554978)
          ];
   /*       var flightPath = new google.maps.Polyline({
        ...
        e.addListener("mouseenter", function(e) {
            return !1
        })
    })
});
var validateErrorPlacement = function(e, t) {
        return !1
    },
    ...
    validateSubmitHandler = function(e) {
        $(e).addClass("loading"), $.ajax({
            ...
            success: function(t) {
                ...
                if(a.success){
                  ...
                  var gtag_action = $(e).find('[name="gtag_action"]').val(),
                    gtag_category = $(e).find('[name="gtag_category"]').val();

                  gtag("event", gtag_action, {
                    event_category: gtag_category
                  })
                } else {
                  $(e).find("[data-error]").html(a.message).show();
                }

                //"success" == a.status ? $(".open-mfp-sucess").click() : $(e).find("[data-error]").html(a.message).show()
            }
        })
    },
    validatePhone = {
...
$("[js-validate-1]").validate(jsValidateOptions), $("[js-validate-2]").validate(jsValidateOptions), $("[js-validate-3]").validate(jsValidateOptions), $("[js-validate-4]").validate(jsValidateOptions), $("[js-validate-5]").validate(jsValidateOptions);
$(document).ready(function(){
    var $navlinkDropdown = $('.nav-link.dropdown');

    $navlinkDropdown.click(function(e){e.preventDefault()})
    $navlinkDropdown.closest('li').hover(
        function(e){
           e.preventDefault();
           var $dropdownBox = $(this).find('.dropdown__box');
           $dropdownBox.fadeIn(400);
        }, function(e) {
            e.preventDefault();
            var $dropdownBox = $(this).find('.dropdown__box');
            $dropdownBox.fadeOut(400);
        }
    );
